...
```html
<div class="student-card" data-id="student-yourusername" onclick="window.openBottomSheetModal(this)">
  ...
  <div class="card-footer">
    ...
    <a href="https://github.com/your-github-username" target="_blank" class="github-link" onclick="event.stopPropagation()">
